...
mix.copy('node_modules/flag-icon-css/flags/1x1/*', 'public/flags/1x1');
mix.copy('node_modules/flag-icon-css/flags/4x3/*', 'public/flags/4x3');
mix.copy('node_modules/select2/dist/css/select2.min.css', 'public/assets/vendor/css/select2/dist/css')
mix.copy('node_modules/select2/dist/js/select2.full.min.js', 'public/assets/vendor/js/select2/dist/js');


mix.js('resources/js/app.js', 'public/js')
    .copy('resources/js/scripts.js', 'public/js')
    .copy('resources/js/custom-datatables.js', 'public/js');
