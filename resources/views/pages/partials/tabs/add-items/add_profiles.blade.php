<div class="col-xxl">
    @php
        do {
           ...
           } while (\App\Models\Profile::where('code', $uniqueCode)->exists());
    @endphp
    ...
    <!-- LABEL -->
    <div class="input-group input-group-lg  mb-3">
        <span class="input-group-text">{{ __('Profile Name') }}</span>
        <input type="text" name="input[language][us][profile-name]" class="form-control" placeholder="{{ __('Profile Name') }}"/>
