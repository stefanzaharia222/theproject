<div class="col-xxl">
    @php
        do {
           ...
           } while (\App\Models\Automation::where('code', $uniqueCode)->exists());
    @endphp
    ...
    <!-- LABEL -->
    <div class="input-group input-group-lg  mb-3">
        <span class="input-group-text">{{ __('Automation Name') }}</span>
        <input type="text" name="input[language][us][automation-name]" class="form-control" placeholder="{{ __('Automation Name') }}"/>
