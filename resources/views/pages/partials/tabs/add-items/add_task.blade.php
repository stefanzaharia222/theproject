<div class="col-xxl add-field-container">
    ...
    <div class="input-group input-group-lg mb-3">
        ...
        <input type="text"
               name="input[type]"
               class="form-control"
               title="This is your type of task"
               readonly
    ...
    <!-- Task Name -->
    <div class="input-group input-group-lg  mb-3">
        <span class="input-group-text">{{ __('Task Name') }}</span>
        <input type="text"
               title="Insert your task name"
               name="input[language][us][task-name][]"
               class="form-control"
